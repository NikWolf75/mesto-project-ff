...
const profileName = document.querySelector('.profile__title'); // Например: "Жак-Ив Кусто"
const profileAbout = document.querySelector('.profile__description'); // Например: "Исследователь океана"
...
editButton.addEventListener('click', () => {
  // Подставляем текущие данные в форму
...
// 5. Навешиваем обработчик на форму
