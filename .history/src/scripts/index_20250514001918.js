...
initialCards.forEach((card) => {
  const cardElement = createCard(card, deleteCard); // Обработчики передаем в createCard
...
addCardForm.addEventListener('submit', (evt) => {
  ...
  const cardElement = createCard(newCard, deleteCard); // не передаем обработчики сюда
...
// Делегирование событий для лайков и изображений
