...
const placesList = document.querySelector('.places-list');  // Замените '.places-list' на актуальный селектор
...
function handleAvatarChange(evt) {
  ...
  if (avatarFile) {
    ...
    reader.onload = function(event) {
      ...
      avatarImage.src = newAvatar;  // Обновляем изображение аватара в профиле
      closePopup(document.querySelector('.popup_type_avatar'));  // Закрываем попап
    };
