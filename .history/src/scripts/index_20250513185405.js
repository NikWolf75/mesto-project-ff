...
initialCards.forEach((card) => {
  const cardElement = createCard(card, deleteCard, handleLike, handleImageClick); // передаем обработчик клика на изображение
...
function handleImageClick(evt, name, link) {
  ...
  const popupImageTitle = document.querySelector('.popup_type_image .popup__caption');
...
// Создание карточки
function createCard({ name, link }, deleteCard, handleLike, handleImageClick) {
