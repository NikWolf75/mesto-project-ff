...
// Функция, которая обновит изображение и подпись при клике
function handleImageClick(evt) {
  ...
  // Получаем сам попап с изображением
  const popupImagePopup = document.querySelector('.popup_type_image');
  openPopup(popupImagePopup);  // Открываем попап с изображением
}

// Стиль изображения в попапе без закруглений
document.querySelector('.popup__image').style.borderRadius = '0';
