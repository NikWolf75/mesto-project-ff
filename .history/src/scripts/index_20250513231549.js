...
const avatarForm = popupAvatarEdit.querySelector('form');
const avatarInput = popupAvatarEdit.querySelector('.popup__input_type_avatar');
...
addCardForm.addEventListener('submit', (e) => {
  ...
  const cardElement = createCard(newCard, deleteCard, handleLike, (event) => handleImageClick(event, openPopup));
